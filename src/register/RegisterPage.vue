...
export default {
    ...
    computed: {
        ...
        getNaverBtn(){
            ...
            var naverBtn = 'https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=gGeZ9i_jrqofbACc0C6q&redirect_uri=http://yeoulab.ga/server/social/naverGetCode&state=register';
            return naverBtn;
        }
    },
    created (){
